...
- Updated the download flow so the current profile state can be downloaded directly without a mandatory review-complete step.
...
- Direct DOCX download still validates the current canonical payload before file generation.
